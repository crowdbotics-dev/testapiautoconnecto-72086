...
## Project Structure
    ...
    ├── testapiautoconnecto_72086  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_72086`
...
2. Clone this repo and `cd testapiautoconnecto_72086`
